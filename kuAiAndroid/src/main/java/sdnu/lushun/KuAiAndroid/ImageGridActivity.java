...
import sdnu.lushun.KuAiAndroid.adapter.ImageGridAdapter;
import sdnu.lushun.KuAiAndroid.adapter.ImageGridAdapter.TextCallback;
import sdnu.lushun.KuAiAndroid.util.AlbumHelper;
import sdnu.lushun.KuAiAndroid.util.Bimp;
import sdnu.lushun.KuAiAndroid.util.ImageItem;
...
public class ImageGridActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		qx = (TextView) findViewById(R.id.up_quxiao);
